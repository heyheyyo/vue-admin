    ...
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">
          版權所有
          <a class="link-type" href="https://gathermaster.com" target="_blank">GatherMaster</a>
        </div>
        <div class="bullshit__headline">{{ message }}</div>
        <div class="bullshit__info">請檢查網址是否有誤。</div>
        <router-link class="bullshit__return-home" to="/">返回首頁</router-link>
      </div>
    </div>
  </div>
</template>
